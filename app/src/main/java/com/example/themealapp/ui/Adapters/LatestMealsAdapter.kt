...
class LatestMealsAdapter(
    ...
    private val latestMealsList: MutableList<MealDetails>
    ...
    override fun onBindViewHolder(holder:LatestMealsVH, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            val action = MainFragmentDirections.actionMainFragmentToDetailsFragment(meal.idMeal,null)
    ...
    class LatestMealsVH(val binding : LatestMealLayoutBinding) : RecyclerView.ViewHolder(binding.root) {
//        val latestMealImage: ImageView = itemView.findViewById(R.id.latest_meal_image)
//        val latestMealName: TextView = itemView.findViewById(R.id.latest_meal_name)
    }
}